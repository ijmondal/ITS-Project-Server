...
url(r'^agromembers/',views.MemberList.as_view()),url(r'^agrophotos/',views.PhotoList.as_view()),url(r'^agrovideos/',views.VideoList.as_view()),
 url(r'^agroyields/',views.YieldList.as_view()),
    url(r'^agrocroprequirment/',views.CropRequirementsList.as_view()),
